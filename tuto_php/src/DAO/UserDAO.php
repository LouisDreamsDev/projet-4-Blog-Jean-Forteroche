...

{
    ...
    {
        $sql = 'INSERT INTO user (pseudo, password, created_at, role_id) VALUES (?, ?, NOW(), ?)';
    ...
    {
        $sql = 'SELECT user.id, user.role_id, user.password, role.name FROM user INNER JOIN role ON role.id WHERE pseudo = ?';
